...
foreach week (`seq 2 1 54`)
	...
	foreach class ($classes)
        	sed -e s/'{CLASS}'/"$class"/g -e s/'{STARTDATE}'/"$startdate"/g -e s/'{ENDDATE}'/"$enddate"/g < template_preProcess_reportsv3_imAnalysis.m > week"$week"_"$class"_preProcess_reports.m
